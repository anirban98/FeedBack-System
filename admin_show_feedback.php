...
$q=mysqli_query($con,"SELECT * FROM `feedback`");
$r=mysqli_num_rows($q);
if($r==false)
{
...
<body>
<div>
<a href="homeAdmin.php"><button class="button button">Back</button></a>
		<h1 class="col-sm-12" style="color:#fff8dc;" align="center" >Feedback</h1>
	
</div>

<table class="table table-bordered" border="1" align="center" style="margin-top:25px">
